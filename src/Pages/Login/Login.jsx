...
function Login() {
  ...
  return (
    <div className="h-screen  w-100  flex items-center shrink-0 " style={{background:`url(${background})`, backgroundSize:"cover"}}>
      <div className="sm:w-3/5 sm:h-3/5 w-4/5  flex flex-col sm:flex-row mx-auto bg-white rounded-2xl">
        <div className="sm:w-2/4 sm:h-full h-full w-full flex flex-col px-8 py-10">
        ...
        <div className="w-2/4 h-full hidden sm:block rounded-r-2xl" style={{background:`url(${loginImg})`, backgroundSize:"cover"}}>
        </div>
      </div>
    </div>
  )
