  ...
  return (
    <div className="h-screen  w-100  flex items-center shrink-0 bg-cover" style={{background:`url(${background})`}}>
        ...
        <div className="w-2/4 h-full flex flex-col px-8 py-10">
          ...
          <input type="text" placeholder="login" className="w-full h-2/5 p-2 border-2 rounded-sm"  required/>
          <input type="Passward" placeholder="passward" className="w-full h-2/5 p-2 border-2 rounded-sm"  required/>
          </form>
          <div className="flex">
            <input type="checkbox" className=''/>
            <div className='px-1'>Remember me</div></div>
          <div className="h-14 bg-[color:var(--primary-green)] rounded-md my-6 flex align center justify-center text-white font-semibold text-lg ">
            <button>login</button>
          </div>
