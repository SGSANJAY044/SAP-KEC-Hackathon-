...
function Wallet() {
  return (
    <div className="h-full w-2/5  mx-10 rounded-3xl flex flex-col justify-end p-10 relative" style={{boxShadow:"12px 11px 28px 1px rgba(0, 0, 0, 0.25)"}}>
                    <div className="absolute  w-40 h-40 rounded-br-full rounded-l-lg bg-gray top-0 left-0 object-contain">
                        <div className="text-8xl absolute top-3 left-2 font-bold text-secondarygreen">22</div>
                    </div>
